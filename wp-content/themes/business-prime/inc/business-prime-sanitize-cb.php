 ...
 */
function business_prime_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function business_prime_sanitize_css( $css ) {
 ...
 */
function business_prime_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function business_prime_sanitize_email( $email, $setting ) {
 ...
 */
function business_prime_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function business_prime_sanitize_html( $html ) {
 ...
 */
function business_prime_sanitize_image( $image, $setting ) {
 ...
 */
function business_prime_sanitize_nohtml( $nohtml ) {
 ...
 */
function business_prime_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function business_prime_sanitize_number_range( $number, $setting ) {
 ...
 */
function business_prime_sanitize_select( $input, $setting ) {
 ...
 */
function business_prime_sanitize_url( $url ) {

...
<ul>
	...
	<li>Dapibus ege-stas turpis.</li>
	   ...
	   $options[] = array(	'desc' => '<div class="home-sections">', 'class' => '','id'=>'home-sections','type' => 'info');
		...
		$options[] = array(	'desc' => '<div class="options-section"><h3 class="groupTitle"><span class="ui-icon ui-icon-arrowthick-2-n-s"><img src="'.$imagepath.'arrows.png'.'" width="16" height="16" alt="'. __('Sort section', 'singlepage').'"></span> '. __('Section', 'singlepage').' '.($i+1).'</h3>', 'class' => 'toggle_option_group home-section group_close','type' => 'info');
		
		$options[] = array(
		'name' => '',
		'desc' => '<div style="overflow:hidden; background-color:#eee;"><a data-section="'.$i.'" class="delete-section button-primary" style="float:right;" title="'.__('Delete', 'singlepage').'">'.__('Delete this section', 'singlepage').'</a></div>',
